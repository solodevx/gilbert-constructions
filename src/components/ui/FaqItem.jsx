    ...
    return (
        <div className='w-full border-b'>
            ...
            <div className={`${isOpen 
                ? "max-h-[200px] opacity-100 transiton-all duaration-500 ease-in-out" 
                : "max-h-0 opacity-0 transiton-all duration-300 ease-in-out overflow-hidden"}`}>
                <p className="pt-8 flex items-center max-w-[860px]">{description}</p>
            </div>
        </div>
    );
};
